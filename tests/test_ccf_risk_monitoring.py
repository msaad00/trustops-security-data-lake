...
EXPECTED = {
    "SG-RISKPRIORITY-001": ["NIST-CSF-ID.RA-04", "NIST-CSF-ID.RA-05"],
    "SG-RISKRESPONSE-001": ["NIST-CSF-ID.RA-06"],
    "SG-AIMONITORING-001": ["NIST-AI-RMF-GOVERN-1.5"],
    "SG-AIPOSTDEPLOYMENT-001": ["NIST-AI-RMF-MANAGE-4.1"],
}
...
def test_new_safeguards_have_provenance_and_no_reviewed_coverage():
    ...
    assert after_coverage["covered"] - before_coverage["covered"] == 5
