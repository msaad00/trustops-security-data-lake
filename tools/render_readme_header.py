...
def _brand_symbols() -> str:
    ...
    return """    <symbol id="mark" viewBox="0 0 48 48">
      ...
      <g fill="none" stroke-width="1.725" stroke-linecap="round" stroke-linejoin="round">
        <path d="M6.75 11.55h7.05a2.25 2.25 0 0 0 .15-4.5 3.3 3.3 0 0 0-6.15.9 1.875 1.875 0 0 0-1.05 3.6" stroke="#4f7cff"/>
        <path d="M24 5.55c.3 2.4 1.35 3.6 3.75 3.9-2.4.3-3.45 1.5-3.75 3.9-.3-2.4-1.35-3.6-3.75-3.9 2.4-.3 3.45-1.5 3.75-3.9Z" fill="#30c7d2" stroke="#30c7d2"/>
        <circle cx="38.25" cy="7.05" r="1.725" stroke="#5eead4"/>
        <path d="M34.2 12.75c.75-2.025 2.1-3 4.05-3s3.3.975 4.05 3" stroke="#5eead4"/>
      </g>
      <path d="M7.5 15c4.8-3.6 10.2-3.6 15.9 0s10.8 3.6 17.1 0M7.5 24c4.8-3.6 10.2-3.6 15.9 0s10.8 3.6 17.1 0" fill="none" stroke="url(#brand)" stroke-width="2.7" stroke-linecap="round"/>
      <path d="M7.5 33c4.8-3.6 10.2-3.6 15.9 0s10.8 3.6 17.1 0" fill="none" stroke="#5eead4" stroke-width="2.7" stroke-linecap="round"/>
    </symbol>
...
def render_logo() -> str:
  ...
  <desc id="desc">Trust Data Lake contour symbol and wordmark.</desc>
  <defs>
    <linearGradient id="brand" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#6d8cff"/><stop offset="1" stop-color="#2dd4bf"/></linearGradient>
{mark_symbol}  </defs>
