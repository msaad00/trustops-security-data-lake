...
Last updated: **2026-07-10** (post #455–#458 merge — queue drained)

## PR queue (max 4)

| PR branch | Issues | Status                                            |
| --------- | ------ | ------------------------------------------------- |
| —         | —      | **Empty** — all four queue PRs merged (#455–#458) |
...
| **F — Backend platform**      | #458       | #419 MCP remote-read, #434 session hashing; **deferred:** #415 split server_app, #413 api/v1 plan, #421 lake_eval (tests exist), #420 rate limit | 🟡 Partial — core slice merged |
...
| [#455](https://github.com/msaad00/trustops-security-data-lake/pull/455) | #435             |
| [#456](https://github.com/msaad00/trustops-security-data-lake/pull/456) | #430, #431, #432 |
...
| #421               | lake_eval eval_overdue test (file mostly exists)           |
...
2. **#421** — lake_eval eval_overdue unit test
3. **#415** — server_app route split (scoped slice)
4. **#420** — distributed rate limiting
