...
Controls are sampled from the active catalog (942 controls after full framework packs). Each open event fans out to `controls_per_event` findings during evaluation.
