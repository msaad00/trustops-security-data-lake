...
| Posture / lake | `get_posture`, `posture_as_of`, `list_controls`, `list_evidence`, `list_evidence_freshness`, `list_violations`, `get_framework_detail`, `get_snapshots_integrity`, `get_snapshot_detail`, `get_tracking_integrity`, `describe_api`                                                                                                                                                                                                                                                                                                                                  |
