...
| GRC programs   | `adopt_policy`, `publish_policy`, `acknowledge_policy`, `create_risk`, `list_risks`, `create_remediation_task`, `update_remediation_task`, `update_evidence_request`, `create_vendor_assessment`, `submit_vendor_assessment`, `create_access_review`, `seed_access_review`, `record_access_review_decision`, `get_policy_template`, `get_policy`, `get_access_review`, `get_vendor_assessment`, … |
