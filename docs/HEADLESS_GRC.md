...
| GRC programs   | `list_vendor_assessments`, `list_vendor_questionnaires`, `get_vendor_questionnaire`, `get_poc_readiness`, `get_platform_usage`, `get_control_remediation`, `list_policies`, `get_policies_coverage`, `list_access_reviews`, `list_risks`, `list_remediation_exceptions`, `list_trust_shares`, … |
