...
export function Toolbar({
  ...
  return (
    <div
      className={
        showFreshness
          ? "grid min-w-0 gap-2 rounded-xl border border-line bg-surface p-2.5 shadow-card md:grid-cols-[minmax(180px,1fr)_minmax(130px,170px)_minmax(120px,150px)_minmax(120px,150px)]"
          : "grid min-w-0 gap-2 rounded-xl border border-line bg-surface p-2.5 shadow-card md:grid-cols-[minmax(180px,1fr)_minmax(140px,180px)_minmax(130px,170px)]"
      }
    >
